function Func_birthdeath_GC_logistic4(BindFlag,paramFlag,NAg,IC1,IC2,ClusterSize,A,CT,ProtF,OnTargetRCF,OffTargetRCF,FitAdv,ProtAg,id,memnumber,Corr12,Multiplier)
rng(1000)
% AllClones = [1:1:228];
expon=1;
global expon;
...
%     end
    ...
    save([flag_str,'_runs',num2str(runNum),'_mem',num2str(memnumber),'_CorrVV',num2str(Corr12),'mu=',num2str(FitAdv),'w=',num2str(2*Multiplier),'.mat'],'lambdaSim','AgCapMeanSim','AgCapSTDSim','IC1tArrAvg','IC2tArrAvg','EAgAbSim','EAgAbExitSim','AgCapExitSim',...
    ...
    save(['eng',flag_str,'_runs',num2str(runNum),'_mem',num2str(memnumber),'_CorrVV',num2str(Corr12),'mu=',num2str(FitAdv),'w=',num2str(2*Multiplier),'.mat'],'OutEngsCellSim','Evar','EMean','EMed');
end
